...
<acme:form>
	<acme:input-textbox code="authenticated.client.form.label.identification" path="identification" placeholder="authenticated.client.form.placeholder.identification"/>
	<acme:input-textbox code="authenticated.client.form.label.companyName" path="companyName"/>
	<acme:input-textbox code="authenticated.client.form.label.type" path="type"  placeholder="authenticated.client.form.placeholder.type"/>
