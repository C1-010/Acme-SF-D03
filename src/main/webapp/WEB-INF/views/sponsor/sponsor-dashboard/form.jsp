...
<table class="table table-sm">
	...
	<tr>
		<th scope="row">
			<acme:message code="sponsor.sponsor-dashboard.form.label.number-of-invoices-with-tax-less-equal-than-21"/>
		</th>
		<td>
			<acme:print value="${numberOfInvoicesWithTaxLessEqualThan21}"/> 
		</td>
	</tr>
	<tr>
		<th scope="row">
			<acme:message code="sponsor.sponsor-dashboard.form.label.number-of-sponsorships-with-link"/>
		</th>
		<td>
	...
	<tr>
		<th scope="row">
			<acme:message code="sponsor.sponsor-dashboard.form.label.maximum-sponsorships-amount"/>
		</th>
		<td>
	...
	<tr>
		<th scope="row">
			<acme:message code="sponsor.sponsor-dashboard.form.label.minimum-sponsorships-amount"/>
		</th>
		<td>
	...
	<tr>
		<th scope="row">
			<acme:message code="sponsor.sponsor-dashboard.form.label.maximum-invoices-quantity"/>
		</th>
		<td>
	...
	<tr>
		<th scope="row">
			<acme:message code="sponsor.sponsor-dashboard.form.label.minimum-invoices-quantity"/>
		</th>
		<td>
